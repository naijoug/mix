...
const api = [
  ...
  // },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        navigationBarTitleText: "关注小程序绑定的抖音号",
      },
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: "获取自定义导航栏元素位置信息",
        path: "tt-get-custom-button-bounding-client-rect/tt-get-custom-button-bounding-client-rect",
      },
      {
        name: "获取菜单按钮的位置信息",
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: '写入日历 addCalendarEvent',
        path: 'tt-add-calendar-event/tt-add-calendar-event'
      },
      {
        name: '查看日历 checkCalendarEvent',
        path: 'tt-check-calendar-event/tt-check-calendar-event'
      },
      {
        name: '删除日历 deleteCalendarEvent',
        path: 'tt-delete-calendar-event/tt-delete-calendar-event'
      },
      {
        name: '唤起短信发送页 sendsms',
        path: 'tt-send-sms/tt-send-sms'
      }, */
    ],
  },
  {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: 'RecorderManager.offStop()',
        path: 'recorder-manager-off-stop/recorder-manager-off-stop',
      },
      {
      ...
      {
        name: "视频 VideoContext.playbackRate",
        path: "video-context-playback-rate/video-context-playback-rate",
      },
      {
        name: "视频 VideoContext.setMediaVolume",
        path: "video-context-set-media-volume/video-context-set-media-volume",
      },
      {
        name: "视频 VideoContext.getMediaVolume",
        path: "video-context-get-media-volume/video-context-get-media-volume",
      },
  ...
  },
  {
    ...
    pages: [
      {
        name: "创建 createSelectorQuery",
        path: "tt-create-selector-query/tt-create-selector-query",
      },
      {
        name: "创建 IntersectionObserver",
